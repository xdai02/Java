...
函数执行一个特定的任务，Java提供了大量内置函数，例如println用来输出字符串、substring()用来截取子字符串等。
...
函数定义时需要指定函数的名称、返回类型和参数。函数的参数列表包括参数的类型、顺序、数量等信息，参数列表可以为空。\\
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{img/Chapter6/6-2/1.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/Chapter6/6-2/2.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/Chapter6/6-2/3.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=1.3]{img/Chapter6/6-2/4.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/Chapter6/6-2/5.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[]{img/Chapter6/6-2/6.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{img/Chapter6/6-2/7.png}
\end{figure}
